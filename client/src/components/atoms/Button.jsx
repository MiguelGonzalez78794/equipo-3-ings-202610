export default function Button({ text, onClick, type = "button", disabled = false, variant = "primary" }) {
  const variants = {
    ...
    secondary: "bg-transparent text-negro-txt border border-gris-bg2 hover:bg-rosa-menu px-4 py-2.5 font-medium text-[15px] rounded-lg ",
    header: "bg-rojo-enf text-blanco-bg border-transparent hover:opacity-70 px-7 py-1.5 font-bold text-[20px] ml-10 hover:shadow-negro-txt translate-y-px rounded-lg",
